...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DRoomsEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            // Targets List
            _roomsList = new ReorderableList(serializedObject, serializedObject.FindProperty("Rooms"), false, false, true, true);
            ...
            _roomsList.drawElementCallback = (rect, index, isActive, isFocused) =>
            {
                ...
                #if UNITY_5
                EditorGUI.PrefixLabel(new Rect(rect.x, rect.y, 65, 10), new GUIContent("Dimensions", "The room size and position"), EditorStyles.boldLabel);
                #else
                    EditorGUI.PrefixLabel(new Rect(rect.x, rect.y, 65, 10), new GUIContent("Transform", "The room size and position"));
                #endif
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (proCamera2DRooms.RestoreOnRoomExit)
            {
                ...
                // Restore ease type
                _tooltip = new GUIContent("Restore on room exit", "The ease type of the restore animation");
